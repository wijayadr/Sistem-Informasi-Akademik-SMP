            ...
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="card-title mb-2">Nilai Anak</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body text-center py-5">
                        ...
                        <h5>Pilih Anak</h5>
                        <p class="text-muted">Silakan pilih anak untuk melihat data nilai.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-header border-bottom-dashed">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title mb-0 flex-grow-1">
                                    <i class="ri-book-open-line me-2"></i>Nilai Per Mata Pelajaran - {{ $selectedStudent->full_name }}
                                </h5>
                            </div>
                        </div>
                        <div class="card-body">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Statistik Nilai - {{ $selectedStudent->full_name }}</h5>
                    </div>
                    <div class="card-body">
