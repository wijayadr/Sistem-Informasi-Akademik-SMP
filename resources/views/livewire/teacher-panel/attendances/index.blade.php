            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">Silakan pilih tahun akademik terlebih dahulu untuk mengelola data absensi siswa.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select wire:model="form.student_id" id="student_id" class="form-select @error('form.student_id') is-invalid @enderror">
                            ...
                            @if($form->schedule_id)
                                @php
                                    $schedule = \App\Models\Academic\Schedule::with(['teacherSubject.class.classStudents' => function($query) {
                                        $query->where('academic_year_id', $this->academic_year_id)->where('status', 'active');
                                    }, 'teacherSubject.class.classStudents.student'])->find($form->schedule_id);
                                    $students = $schedule ? $schedule->teacherSubject->class->classStudents : collect();
                                @endphp
