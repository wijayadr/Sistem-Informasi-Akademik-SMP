...
namespace App\Livewire\ParentPanel\Grades;
...
class Index extends Component
{
    ...
    public function getGradeStats()
    {
        ...
        $query = StudentGrade::where('student_id', $this->selected_student_id)
            ->whereHas('teacherSubject', function ($query) use ($studentClass) {
                $query->where('class_id', $studentClass->class_id)
                      ->where('academic_year_id', $this->academic_year_id);
            });
    ...
    public function getGradeProgressChart()
    {
        ...
        while ($current <= $end) {
            $grades = StudentGrade::where('student_id', $this->selected_student_id)
                ->whereHas('teacherSubject', function ($query) use ($studentClass) {
                    $query->where('class_id', $studentClass->class_id)
                          ->where('academic_year_id', $this->academic_year_id);
                })
    ...
    public function render()
    {
        ...
        return view('livewire.parent-panel.grades.index', compact(
            'grades',
            'gradeStats',
            'academicYears',
            'selectedStudent',
